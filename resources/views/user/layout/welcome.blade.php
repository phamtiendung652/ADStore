...
<!-- Mirrored from unionagency.one/exzo/index1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 17:05:38 GMT -->
<head>
    ...
    <link href="{{asset ('assets/user/css/bootstrap.extension.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('assets/user/css/style.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('assets/user/css/swiper.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('assets/user/css/sumoselect.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset ('assets/user/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
                ...
                <div class="content-margins">
                    <div class="row">
                        <div class="col-xs-3 col-sm-1">
                            <a id="logo" href="index1.html"><img src="img/logoM.png" alt="" /></a>  
                        </div>
    ...
    <script src="{{asset('assets/user/js/swiper.jquery.min.js')}}"></script>
    <script src="{{asset('assets/user/js/global.js')}}"></script>

    <!-- styled select -->
    <script src="{{asset('assets/user/js/jquery.sumoselect.min.js')}}"></script>

    <!-- counter -->
    <script src="{{asset('assets/user/js/jquery.classycountdown.js')}}"></script>
    <script src="{{asset('assets/user/js/jquery.knob.js')}}"></script>
    <script src="{{asset('assets/user/js/jquery.throttle.js')}}"></script>

</body>

<!-- Mirrored from unionagency.one/exzo/index1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Dec 2024 17:06:24 GMT -->
</html>
